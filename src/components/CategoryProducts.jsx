...
const CategoryProducts = () => {
  ...
  return (
    <div className="flex flex-col w-full px-3 md:px-20 my-16">
      ...
      <div className="mb-2 container flex w-full h-full border-t-2 border-red-300 border-solid border-opacity-80">
        {isLoading ? (
          ...
          <section className="flex max-[1024px]:items-center max-[1024px]:justify-center items-center w-full gap-12 max-[480px]:gap-7 flex-wrap mt-6">
            {products ? (
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="w-full h-full items-center justify-center gap-3 px-8 py-5 flex flex-col rounded-xl bg-white upcmvs__bck">
                        ...
                        <div className="flex w-full item-center justify-start text-sm max-[480px]:text-xs max-[480px]:text-xs font-inter font-semibold">
                          Color:&nbsp;
                          <span

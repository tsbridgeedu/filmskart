    ...
    <>
      <div className="flex h-[600px] flex-col py-8 rounded-md w-[850px] ml-20 border-1 border max-[1023px]:w-[450px] max-[768px]:w-[340px] max-[1023px]:h-[600px] max-[768px]:ml-3 mng_pfl_crd">
        <div className="flex flex-col px-10 py-6">
          ...
          <div className="flex flex-col scrollbar overflow-y-scroll mt-7 rounded-md h-[400px] px-4 border">
            ...
            <p className="font-inter mt-1">
              ...
              original packaging. Items such as perishable goods, personalized
              items, and gift cards are not eligible for return.
            </p>
            ...
            <p className="font-inter mt-1">
              ...
              within 7 days of receiving your order. Provide your order number
            ...
            <p className="font-inter mt-1">
              {" "}
              Customers are responsible for the cost of return shipping, except
              in cases where the item received was defective or damaged. We
              recommend using a trackable shipping service and purchasing
              shipping insurance for high-value items.{" "}
              <strong className="font-inter">Filmskart</strong> is not liable
              for items lost or damaged during return shipping.
            </p>
            <span className="font-inter text-red-500 font-medium mt-8">
              Refunds:
            </span>
            ...
            <p className="font-inter mt-1">
              {" "}
              If you need to exchange an item for the same product or a
              different one, please contact our customer support team. We will
              assist you in processing the exchange.
            </p>
            <span className="font-inter text-red-500 font-medium mt-8">
            ...
            <p className="font-inter mt-1 mb-5">
              ...
              goods, personalized items, and gift cards.
            </p>
          </div>
        </div>
      </div>
